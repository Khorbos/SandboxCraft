...
public class ItemInit {
    ...
    public static final HammerItem test_hammer = null;
    ...
    public static void registerItems(final RegistryEvent.Register<Item> event){
        ...
        event.getRegistry().register(new HammerItem(ModItemTier.EMERALD, 2, 2.0F, new Item.Properties().group(Sandbox.itemGroup)).setRegistryName("test_hammer"));
    }
